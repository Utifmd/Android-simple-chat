package com.app.utif.android_simple_chat.auth;
...
import com.app.utif.android_simple_chat.MainActivity;
    ...
    private void readDefaultData() {
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                User valuePerson = dataSnapshot.getValue(User.class);
                if (valuePerson != null){
                    //setUserOnline();
                    Toast.makeText(getApplicationContext(), "Welcome."+ valuePerson.getSender(), Toast.LENGTH_LONG).show();
                }else {
                    createNewUser();
                }
            }
        ...
        mRef().child("users").child(mUser().getUid()).addValueEventListener(postListener);
    }

    private void createNewUser(){
        User user = buildNewUser(mUser());
        mRef().child("users").child(mUser().getUid()).setValue(user);
    }
